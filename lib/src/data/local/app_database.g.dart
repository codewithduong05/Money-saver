...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, amount, isExpense, note, categoryId, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Wallet extends DataClass implements Insertable<Wallet> {
  ...
  const Wallet({required this.id, required this.name, required this.balance});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  Wallet copyWith({String? id, String? name, double? balance}) => Wallet(
    id: id ?? this.id,
    name: name ?? this.name,
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, categoryId, limit, month];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  Budget copyWith({int? id, int? categoryId, int? limit, int? month}) => Budget(
    id: id ?? this.id,
    categoryId: categoryId ?? this.categoryId,
  ...
  @override
  int get hashCode => Object.hash(id, categoryId, limit, month);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Budget &&
